  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logo topbar-btn">
        <a href="/"><img src="../assets/heist1.png" style="padding-left:8px;"></a>
      </div>
     <!--
      <div class="topbar-title">
        <span style="font-size: 18px;color: #fff;">Laundry后台管理系统</span>
      </div>
     -->
      ...
      <aside :class="{showSidebar:!collapsed}">
        ...
        <el-menu :default-active="defaultActiveIndex" router :collapse="collapsed" @select="handleSelect">
          <template v-for="(item,index) in $router.options.routes" v-if="item.menuShow">
            ...
            <el-menu-item v-else-if="item.leaf&&item.children&&item.children.length" v-show="adminDisplay" :index="item.children[0].path"
  ...
  export default {
    ...
    created(){
      bus.$on('setNickName', (text) => {
        this.nickname = text;
        //according to username to query privilege , then decide how to show 
