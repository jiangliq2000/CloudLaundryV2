    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="form" label-width="100px" >		
		  ...
		  <div>
          <el-form-item label="设备号查询" >
            <el-select v-model="form.devId" filterable remote reserve-keyword  placeholder="请输入设备号" @change="devIdChanged" :remote-method="remoteMethod" :loading="loading">
              <el-option v-for="item in searchDevIds" :key="item.value"  :label="item.label" :value="item.value">
              </el-option>
            </el-select>
 		 </el-form-item>	
